    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'icare_variables_prepare_save',
                ['post' => $model, 'request' => $this->getRequest()]
            );
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved this variable.'));
                $this->_objectManager->get('Magento\Backend\Model\Session')->setFormData(false);
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['variable_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['variable_id' => $this->getRequest()->getParam('variable_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}